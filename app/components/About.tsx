    ...
    <svg viewBox="0 0 520 320" className="w-full h-auto" aria-hidden>
      <defs>
        <marker
          ...
          orient="auto"
        >
          <path d="M0,0 L10,5 L0,10 Z" fill="#20beff" />
        </marker>
      </defs>
  ...
  return (
    <div className="grid md:grid-cols-[1fr_1fr] gap-10 mb-20">
      <div className="flex flex-col gap-4">
        ...
        >
          WHAT IS <span className="text-[#20beff]">KAGGLE?</span>
        </h3>
      ...
      <div
        className="relative rounded-md border border-[#20beff]/20 bg-[#020d1a]/70 p-6 overflow-hidden"
        style={{
          backgroundImage:
...
function GalleryTile({ src, index }: { src: string | null; index: number }) {
  ...
  if (src) {
    return (
      <div className={`${base} border-[#20beff]/25`}>
        <img
          src={`/gallery/${src}`}
  ...
  return (
    <div
      className={`${base} border-[#20beff]/20 bg-[#020d1a]/70 flex items-center justify-center`}
      style={{
        backgroundImage:
    ...
    >
      ...
      <span className="absolute top-2 left-2 h-2.5 w-2.5 border-t border-l border-[#20beff]/50" />
      <span className="absolute top-2 right-2 h-2.5 w-2.5 border-t border-r border-[#20beff]/50" />
      <span className="absolute bottom-2 left-2 h-2.5 w-2.5 border-b border-l border-[#20beff]/50" />
      <span className="absolute bottom-2 right-2 h-2.5 w-2.5 border-b border-r border-[#20beff]/50" />
    </div>
  );
}
  ...
  return (
    <div className="mb-20">
      ...
      <div
        ...
        style={{
          scrollbarWidth: "thin",
          scrollbarColor: "#20beff55 transparent",
        }}
      >
  ...
  return (
    <div>
      <div className="flex flex-col-reverse md:grid md:grid-cols-[1fr_1fr] gap-10 mb-20">
        <div
          className="relative rounded-md border border-[#20beff]/20 bg-[#020d1a]/70 overflow-hidden aspect-[1.7]"
          style={{
            backgroundImage:
              "repeating-linear-gradient(0deg, rgba(32,190,255,0.03) 0px, rgba(32,190,255,0.03) 1px, transparent 1px, transparent 3px)",
          }}
        ...
        <div className="flex flex-col">
          ...
          >
            Stock Market
            <br />
            <span className="text-[#20beff]">Prediction</span>
          </h3>
